...
> Ao utilizar o Leon Bot, você concorda com os termos descritos abaixo.
...
### 🔓 Uso Open Source
O Leon Bot é um projeto **open source** e deve permanecer assim. O arquivo original **não pode ser comercializado**. Se você utilizou o Leon como base e realizou **diversas modificações**, criando essencialmente um bot diferente, aí sim você pode comercializar a sua versão.
...
Você pode clonar o repositório e modificar o projeto livremente, criando sua própria versão do Leon como quiser.

No entanto, essas modificações não devem ser divulgadas como uma versão oficial do projeto Leon, nem associadas ao repositório original, para evitar confusões ou mal-entendidos na comunidade.

O repositório oficial do Leon Bot é mantido exclusivamente por String_1234, e apenas ele é responsável pelas versões oficiais e atualizações públicas do projeto.
